...
TOPIC_ARN = os.getenv("SNS_TOPIC_ARN") #SNS ARN NUMBER FOR NOTIFICATION
...
def _create_ticket(question: str, email: str = None) -> dict:
    ...
    logger.info("Created ticket %s with category %s and priority %s",
                ticket_id, item["category"], item["priority"])
