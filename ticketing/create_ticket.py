...
TOPIC_ARN = os.getenv("arn:aws:sns:ap-southeast-1:123456789012:your-topic-name") #SNS ARN NUMBER FOR NOTIFICATION
...
def create_ticket(question: str) -> dict:
    ...
    logger.info(f"Ticket created and stored: {item}")
